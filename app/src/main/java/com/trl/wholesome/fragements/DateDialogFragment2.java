...
public class DateDialogFragment2 extends DialogFragment {

	public static String TAG = "DateDialogFragment";
	public static Context mContext; // I guess hold the context that called it. Needed
	...
	public static DateDialogFragment2 newInstance(Context context,
												  DateDialogFragmentListener listener, Calendar now) {
		DateDialogFragment2 dialog = new DateDialogFragment2();
		mContext = context;
		mListener = listener;
